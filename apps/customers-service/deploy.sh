...
REGION="us-east-1"
SERVICE_DIR="customers-service"  # en este contexto, estamos parados en esa carpeta
...
../gradlew :customers-service:awsJar || { echo "❌ Falló la compilación con Gradle"; exit 1; }
