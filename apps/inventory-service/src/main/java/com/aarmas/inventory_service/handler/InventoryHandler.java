...
import com.aarmas.inventory_service.InventoryServiceApplication;
...
public class InventoryHandler implements RequestStreamHandler {
    ...
    static {
        try {
            ...
            handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(InventoryServiceApplication.class);
